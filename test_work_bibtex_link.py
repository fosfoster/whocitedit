#!/usr/bin/env python3
"""Offline coverage for BibTeX download links on rendered work pages."""
import json
import re
import shutil
import sys
...
def main() -> int:
    ...
    try:
        ...
        for wid in ("W1", "W2", "W3"):
            ...
            if len(bibtex_links) == 1:
                ...
                expected = (render.SITE / "w" / wid / "citation.bib").resolve()
    ...
    print("test_work_bibtex_link:", "FAILED" if bad else "ok")

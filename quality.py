...
NOTE_TEMPLATES = {
    ...
    "venue_source": {
        AGREE: "The sources agree about this work's venue.",
        UNAVAILABLE: "No comparable source assertion is available for this work's venue.",
        CROSSREF_DISAGREES: "Crossref disagrees with OpenAlex about this work's venue. Each is shown as a parallel observation; none is corrected here.",
        EUROPEPMC_DISAGREES: "Europe PMC disagrees with OpenAlex about this work's venue. Each is shown as a parallel observation; none is corrected here.",
        BOTH_DISAGREE: "Both Crossref and Europe PMC disagree with OpenAlex about this work's venue. Each is shown as a parallel observation; none is corrected here.",
    ...
    "title_source": {
        AGREE: "The sources agree about this work's title.",
        UNAVAILABLE: "No comparable source assertion is available for this work's title.",
        CROSSREF_DISAGREES: "Crossref disagrees with OpenAlex about this work's title. Each is shown as a parallel observation; none is corrected here.",
        EUROPEPMC_DISAGREES: "Europe PMC disagrees with OpenAlex about this work's title. Each is shown as a parallel observation; none is corrected here.",
        BOTH_DISAGREE: "Both Crossref and Europe PMC disagree with OpenAlex about this work's title. Each is shown as a parallel observation; none is corrected here.",
    ...
    "date_source": {
        AGREE: "The sources agree about this work's publication date.",
        UNAVAILABLE: "No comparable source assertion is available for this work's publication date.",
        CROSSREF_DISAGREES: "Crossref disagrees with OpenAlex about this work's publication date. Each is shown as a parallel observation; none is corrected here.",
        EUROPEPMC_DISAGREES: "Europe PMC disagrees with OpenAlex about this work's publication date. Each is shown as a parallel observation; none is corrected here.",
        BOTH_DISAGREE: "Both Crossref and Europe PMC disagree with OpenAlex about this work's publication date. Each is shown as a parallel observation; none is corrected here.",
